...
public abstract class HttpResponse {
    ...
    private Charset _charset = CharsetUtil.UTF8;
    ...
    public void setHeader(String name, String text) throws ArgumentNullException,InvalidOperationException {
        if (name == null) {
        ...
        if (header == null) {
            setHeader(new HttpHeader(name, text));
        } else {
            checkAndThrowHeaderSent();
            header.text(text);
        }
    ...
    public abstract void setHeader(HttpHeader header) throws ArgumentNullException,InvalidOperationException;
